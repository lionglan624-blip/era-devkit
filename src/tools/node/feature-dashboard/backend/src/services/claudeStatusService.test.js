...
const MOCK_COMPONENTS = [
  { id: 'comp1', name: 'Claude Code', status: 'operational', created_at: '2025-01-01', position: 1 },
  { id: 'comp2', name: 'Claude API', status: 'operational', created_at: '2025-01-01', position: 2 },
  { id: 'other', name: 'Other Service', status: 'major_outage', created_at: '2025-01-01', position: 3 },
];
